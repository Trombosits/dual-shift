...
@onready var next_panel = $"../UI/NextPanel"
...
func spawn_priority_npc():

	if priority_spawned:
		return

	priority_spawned = true

	var npc = priority_npc_scene.instantiate()
...
func _on_next_button_pressed() -> void:
	click_sfx.play()
	get_tree().paused = false
	get_tree().change_scene_to_file("res://Scenes/tutorial/storage_room.tscn")
